...
\title{QUANTUM VEGA CONTINUUM: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, QUANTUM VEGA CONTINUUM'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
